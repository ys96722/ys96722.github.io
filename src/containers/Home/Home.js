    ...
    return (
      <>
        ...
        <WhenInView>
          {({ isInView }) => (
            <RevealP hide={!isInView}>
              ...
              Illinois. Born between an opera singer and an entrepreneur in the
              heat of July, I aspire to live a life full of opportunities to
              create new things.
            </RevealP>
          )}
        </WhenInView>
        ...
        <WhenInView>
          {({ isInView }) => (
            <RevealP hide={!isInView}>
              ...
              innovative spirit. I learned a lot when working with him on web
              development projects for startup companies incubating at the
              University of Illinois Research Park. He was always sure that the
        ...
        <WhenInView>
          {({ isInView }) => (
            <RevealP hide={!isInView}>
              "I worked with Yoon in multiple projects at EnterpriseWorks. I
              could go on and on to talk about great things that Yoon
              contributed to the team, but if I have to summarize it, I would
              describe Yoon as someone who is dependable, personable, and always
              goes above and beyond what you expect. Yoon is dependable because
              you know he will get the work done on time and with outstanding
              quality. His ability to see the big picture while paying attention
              to the small details never ceases to impress me. Yoon’s
              personality makes everyone in the team enjoy working with him.
              Yoon is an excellent communicator and listener. He listened to the
              client’s concerns and provided insights and solutions to the
              client. Lastly and the most critical thing, Yoon is passionate
              about what he does , and he enjoys sharing his knowledge and
              skills to help others. Last summer, Yoon realized that many
              interns at EnterpriseWorks were interested in learning web
              development and data analytics. Yoon not only coordinated a
              sharing session with other interns during work hours but also
              arranged a group study session twice a week after office hours for
              those who were interested to learn more. I could not think of
              anyone as well-rounded as Yoon. We are grateful to have him on the
              team!"
              <P>
                -{" "}
                <A
