...
import { media, sizes } from "../../style/media"
...
export const ResumePageContainer = styled(PageContainer)``
...
export const Section = styled(Flex)<ISectionProps>`
  /* flex-direction: row; */
  /* position: relative; */
...
export const Column = styled(Flex)<IColumnProps>`
  /* position: absolute; 
  bottom: 0;
  left: 0; */
  flex-direction: column;
...
interface IColumnTitleProp {
  bgColor?: string
}

export const ColumnTitle = styled.h1<IColumnTitleProp>`
...
export const JobTitle = styled(CompanyTitle)<IJobTitleProps>`
  margin-bottom: 0;
