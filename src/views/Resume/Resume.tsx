...
const Resume = () => {
  const [firstVisitHover, setFirstVisitHover] = React.useState(false)
  const navigate = useNavigate()

  const handleFirstHover = event => {
    event.preventDefault()
    if (firstVisitHover === false) {
      setFirstVisitHover(true)
    }
  }
    ...
    return (
      <ResumePageContainer>
        ...
        <ResumeContainer animation="fadeIn" style={{ position: "relative" }}>
          <PageHeader>
            ...
            <PageSubTitle>
              ...
              <A
                ...
                target="_blank"
                onClick={e => handleClick("LinkedIn Link in Intro")}
              >
                LinkedIn!
              </A>
            </PageSubTitle>
            ...
            <Section flexDirection="column" justifyContent="top">
              ...
              <Row marginTop="4rem">
                ...
                <Column width="70%" textAlign="left">
                  ...
                  <ul>
                    <Li>
                      Created Reddit-like discussion forum to facilitate
                      innovation within the company using React.js, Redux, and
                      Node.js
                    </Li>
                    <Li>
                      Developed client-side stack for an interactive data
                ...
                <Column width="30%" textAlign="left">
                  <CompanyTitle>
                    <A
                      ...
                      target="_blank"
                      onClick={e => handleClick("KoJobs Link")}
                    >
                      KoJobs
                    </A>
                  </CompanyTitle>
          ...
          <SectionContainer className="skills" marginTop="3rem">
            <Title>Skills</Title>
            {/* <InfoIndex /> */}
